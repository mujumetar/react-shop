...
//   {
//     id: 1,
//     image: "/white.jpg", // replace with your actual images
...
//   {
//     id: 3,
//     image: "/hero3.jpg", // add a third beautiful image
...
//                   className={`block bg-gradient-to-r ${slides[index].gradient} bg-clip-text text-transparent`}
//                   style={{ 
...
//                 className="text-xl md:text-2xl text-gray-200 font-light max-w-4xl mx-auto leading-relaxed tracking-wide"
//               >
...
//                   whileTap={{ scale: 0.95 }}
//                   className="group relative px-12 py-6 bg-gradient-to-r from-amber-500 to-orange-600 text-white text-xl font-bold rounded-2xl shadow-2xl overflow-hidden"
...
//                 <motion.button
//                   whileHover={{ scale: 1.05 }}
//                   className="px-12 py-6 border-2 border-white/50 backdrop-blur-xl text-white text-xl font-semibold rounded-2xl hover:bg-white/10 transition-all"
//                 >
...
//       <button
//         onClick={prev}
//         className="absolute left-8 top-1/2 -translate-y-1/2 p-4 bg-white/10 backdrop-blur-xl rounded-full hover:bg-white/20 transition-all group"
//       >
//         <ChevronLeft className="w-8 h-8 text-white" />
//       </button>
//       <button
//         onClick={next}
//         className="absolute right-8 top-1/2 -translate-y-1/2 p-4 bg-white/10 backdrop-blur-xl rounded-full hover:bg-white/20 transition-all group"
//       >
...
//           >
//             <motion.div
//               className="w-16 h-1 rounded-full bg-white/30 overflow-hidden"
//               animate={{ 
//                 background: i === index ? 
